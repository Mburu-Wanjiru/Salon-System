...
if(isset($_POST['submit']))
{
	...
	$query=mysqli_query($con,"insert into tblcontact(Name,Email,Subject,Message) value('$name','$email','$subject','$message')");
	if ($query) 
	{
    ...
    <div class="container">
      <div class="row d-flex contact-info">
        ...
        <div class="col-md-4 d-flex">
         <div class="dbox">
           <p><span>Address:</span> SPA Street , Kitui-Town</p>
         </div>
       </div>
       <div class="col-md-4 d-flex">
         <div class="dbox">
           <p><span>Phone:</span> <a href="tel://1234567920">+ 254 727 756 847</a></p>
         </div>
       </div>
       <div class="col-md-4 d-flex">
         <div class="dbox">
           <p><span>Email:</span> <a href="mailto:info@.com">info@gmail.com</a></p>
         </div>
       </div>
     </div>
   </div>
    ...
    <div class="row d-flex align-items-stretch no-gutters">
     <div class="col-md-6 p-5 order-md-last">
      ...
      <form action="" method="POST">
        ...
        <div class="form-group">
          <input type="" name="submit" value="Send Message" class="btn btn-primary py-3 px-5">
        </div>
      </form>
    </div>
